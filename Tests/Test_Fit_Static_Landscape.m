...
trueT = computeTransitionMatrix(simX, trueU, dt, ...
    ...
    'DiffusionCoefficient', trueD, 'PointDiffusionCoefficient', D0, ...
...
initGuess = [zeros(numel(trueFixHeights), 1); 1; 1];
...
[optErr, fixHeights, D, scalarMetric, timeScale, fitTimes, optOutput] = ...
    ...
    'ConstDiffusionCoefficient', [], 'EnforcePositiveDiffusion', true, ...
