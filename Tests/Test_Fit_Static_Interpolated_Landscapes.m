...
initGuess = [initGuess(:,1); 1; initGuess(:,2); 1; 0.5];
constFixHeights = [];
...
[optErr, fixHeights0, scalarMetric0, fixHeights1, scalarMetric1, ...
    interpParam, timeScales, optTimes, optOutput] = ...
    ...
    'VolumeElementType', 'LaplaceBeltrami', ...
    'UpperBounds', [inf(numel(isSaddle), 1); 2; inf(numel(isSaddle), 1); 2; 1], ...
